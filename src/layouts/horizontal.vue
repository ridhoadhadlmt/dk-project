        ...
        <div id="scrollbar">
          <BContainer fluid>
            <ul class="navbar-nav h-100" id="navbar-nav">
              ...
              <li class="nav-item">
                <BLink class="nav-link" href="#sidebarMore" data-bs-toggle="collapse" role="button"
                ...
                <div class="collapse menu-dropdown show" id="sidebarMore">
                  <ul class="nav nav-sm flex-column">
                    ...
                    <li class="nav-item">
                      <BLink class="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse"
