    ...
    data() {
        return {
            ...
            types: [
                ...
                {text: 'Perawatan', value: 'perawatan'},
                {text: 'Penambahan Nilai', value: 'penambahan_nilai'},
            ],
            periodics: [
...
<template>
    <Layout>
        ...
        <SelectHeader :showModal="modalHeaderFuel" :headers="fuelHistoryHeaders" @hideModal="hideHeaderFuel" @selectHeader="showHeaderFuel" />
        ...
        <SelectHeader :showModal="modalHeaderBacklog" :headers="backlogHeaders" @hideModal="hideHeaderBacklog" @selectHeader="showHeaderBacklog" />
                ...
                <BCard>
                    <BCardBody>
                        <BRow>
                            ...
                            <BCol md="10">
                                <h2 class="text-truncate">{{ data.name }}</h2>
                                <BRow>
                                    <BCol md="3">
                                        <div class="d-flex">
                                            <div class="w-50">
                                            ...
                                            <div class="w-50">
                                                <h5 class="text-truncate"><span class="px-3">: {{ data.fleetType}}</span></h5>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                            <div class="w-50">
                                    ...
                                    <BCol md="3">
                                        <div class="d-flex">
                                            ...
                                            <div class="w-50">
                                                <h5 class="text-truncate"><span class="px-3">:</span>{{ data.serialNumber}}</h5>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                            <div class="w-50">
                                    ...
                                    <BRow class="gy-4">
                                            ...
                                            <div class="reminders border shadow-sm rounded-4">
                                                <div class="d-flex justify-content-between align-items-center border-bottom">
                                                    <div class="p-4 d-flex align-items-center">
                                                        <h4>Reminders </h4><BBadge class="fs-16 d-flex align-items-center justify-content-center w-25 h-25 rounded-circle ms-2" variant="danger">{{ reminders.length }}</BBadge> <i class="bx bxs-info-circle fs-22 ms-2"></i>
                                                    </div>
                                                    <div>
                                                ...
                                                <table-component :headers="reminderHeaders" :data="reminders" :action="action" v-if="reminders.length > 0" @sort="sort($event.sortBy)">
                                                    ...
                                                    <template #status="{ item }">
                                                        <BBadge :variant="item.status === 'overdue' ? 'danger' : item.status === 'waiting' ? 'warning' : 'success'" pill size="sm">
                                                            {{ item.status == 'waiting' ? 'Sedang Menunggu' : item.status == 'Due Now' ? 'duenow' : 'Completed' }}
                                                        </BBadge>
                                            ...
                                            <div class="work-orders border shadow-sm rounded-4">
                                                ...
                                                <div class="live-preview">
                                                    <table-component :headers="workOrderHeaders" :data="workOrders" :action="action" v-if="workOrders.length > 0" @sort="sort($event.sortBy)">
                                                        ...
                                                        <template #status="{ item }">
                                                            <BBadge v-if="item.status ==='in_progress'" variant="info" pill>
                                                                In Progress
                                                            </BBadge>
                                                        </template>
                                                        <template #action="{ item }">
                                        ...
                                        <BCol lg="12">
                                            <div class="issues border shadow-sm rounded-4">
                                                ...
                                                <div class="d-flex flex-wrap justify-content-between p-lg-4">
                                                    <div>
                                                        <BButton variant="light" class="btn btn-md me-2 mb-2 mb-lg-0" style="white-space: nowrap;" @click="showHeaderBacklog">
                                                            <i class="bx bx-dots-vertical-rounded"></i>
                                                        </BButton>
