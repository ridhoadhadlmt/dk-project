                    ...
                    <BCardBody>
                        <BForm @submit.prevent="submit">
                            <BRow class="gy-4">
                                <BCol md="6">
                                    <div>
                                        <label for="code-fleet" class="form-label">Referensi WO<span class="text-danger">*</span></label>
                                        <select id="code-fleet" class="form-select" required>
                                            <option selected>Pilih referensi issue</option>
                                ...
                                <BCol md="6">
                                    <div>
                                        <label for="duration" class="form-label">Kode fleet <span class="text-danger">*</span></label>
                                        <select id="code-fleet" class="form-select" required>
                                ...
                                <BCol md="6">
                                    <div>
                                        <label for="title" class="form-label">Judul Backlog <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="title" placeholder="Masukkan judul WO" v-model="form.type_fleet" required>
                                    </div>
                                </BCol>
                                <BCol md="6">
                                    <div>
                                        <label for="notification" class="form-label">Jenis Backlog <span class="text-danger">*</span></label>
                                        <select id="code-fleet" class="form-select" required>
                                ...
                                <BCol md="6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control border-end-0" id="date" placeholder="Upload Dokumen" v-model="form.date" required>
                                        <span class="input-group-text border-start-0 bg-transparent fs-22"><img src="@/assets/icons/doc.svg" width="20"></span>
                                    </div>
                                </BCol>
                                <BCol md="12">
                                    <div>
                                        <label for="comment" class="form-label">Komen <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="comment" placeholder="Masukkan komen" v-model="form.type_fleet" required>
                                ...
                                <BCol md="3">
                                    <div>
                                        <label for="title" class="form-label">Estimasi Biaya WO<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="title" placeholder="0" v-model="form.type_fleet" required>
                                    </div>
                                </BCol>
                ...
                <div class="bg-white rounded-4">
                    ...
                    <div class="live-preview">
                        <table-component :headers="headers" :data="data" :action="action" v-if="data.length > 0" @sort="sort($event.sortBy)">
                            ...
                            <template #qty="{ item }">   
                                <span class="badge rounded-pill bg-danger-subtle text-white fs-12">{{ item.qty}}</span>
                            </template>
                    ...
                    <div class="cta p-lg-4">
                        <div class="d-flex justify-content-end">
                            <BButton variant="light" class="me-2">Kembali</BButton>
                            <BButton variant="light" class="me-2">Simpan Sebagai Draft</BButton>
                            <BButton variant="dark">Publish</BButton>
                        </div>
                    </div>
                </div>
            </BCol>
