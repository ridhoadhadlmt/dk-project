...
export default {
    ...
    methods: {
        ...
        fetchWO() {
            axios.get(process.env.VUE_APP_API_URL + '/v1/work-orders').then((response) => {
                this.wo = response.data.data.items;
            }).catch((error) => {
                console.log(error);
            });
        },
                            ...
                            <BRow class="gy-4">
                                <BCol md="6">
                                    <div>
                                        ...
                                        <multiselect v-model="form.workOrderId" 
                                            :options="wo" 
                                            :searchable="false" 
                                            placeholder="Pilih Referensi WO" 
                                            :allow-empty="false" 
                                            value-prop="id" 
                                            label="title">
                                ...
                                <BCol md="6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" id="code-fleet" required disabled>
                                    </div>
                                </BCol>
                                <BCol md="6">
                                    <div>
                                        <label for="category" class="form-label">Kategori <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="category" required v-model="form.category">
                                    </div>
                                </BCol>
                                <BCol md="6">
                                    <div>
                                        <label for="title" class="form-label">Judul Backlog <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="title" placeholder="Masukkan judul backlog" v-model="form.title" required>
                                    </div>
                                </BCol>
                                <BCol md="6">
                                    <div>
                                        <label for="notification" class="form-label">Jenis Backlog <span class="text-danger">*</span></label>
                                        <multiselect v-model="form.type" :options="woTypes" :searchable="false" placeholder="Pilih Jenis Backlog" :allow-empty="false" value-prop="id" label="name">
                                            <template #singleLabel="{ option }"><strong>{{ option.name }}</strong></template>
                                        </multiselect>
                                    </div>
                                </BCol>
                                <BCol md="6">
                                    <div>
                                        <label for="notification" class="form-label">Periodic Backlog <span class="text-danger">*</span></label>
                                        <BFormRadioGroup
                                        size="lg"
                                ...
                                <BCol md="6">
                                    <div>
                                        ...
                                        <multiselect v-model="form.picId" 
                                            :options="users" 
                                            :searchable="false" 
                                            placeholder="Pilih Pic Mekanik" 
                                            :allow-empty="false" 
                                            value-prop="id" 
                                            label="fullName">
