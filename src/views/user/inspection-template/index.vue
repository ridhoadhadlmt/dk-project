        ...
        return {
            headers: [
                ...
                },
                {
                    ...
                    key: 'periode_date_start',
                    show: true,
                    order:true
                },
                {
                    title: 'Tanggal Selesai Periode',
                    key: 'periode_date_end',
                    show: true,
                    order:true
                },
                {
            ...
            data: [
                {id: 1, code: 'K001', title: 'Lorem Ipsum dolor....', periode: 'Harian', periode_date_start: '17 April 2024',periode_date_end: '17 Mei 2024'}
            ],
            params: {
                page: 1,
                limit: 10,
                        ...
                        <div class="d-flex flex-wrap justify-content-between py-lg-4">
                            ...
                            <div class="d-flex flex-wrap align-items-center mt-2 mt-lg-0" id="filter-button">
                                ...
                                <div class="d-flex flex-wrap justify-content-sm-end me-2 mb-2 mb-lg-0" style="flex-grow: 1;">
                                    ...
                                    <router-link :to="{ name: 'inspection-template-create' }">
