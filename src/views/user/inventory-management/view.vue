...
export default {
    ...
    data() {
        return {
            // datas: null,
            datas: [
                {no: 1, name: 'Perfleetan 1', code: 'P001', category: 'Tools', quantity: 1, storageLocation: 'Bandung'},
                {no: 2, name: 'Spare Part 2', code: 'SP001', category: 'Spare Part', quantity: 10, storageLocation: 'Bandung'},
            ]
        };
    },
    watch: {
                    ...
                    <BCardBody>
                        ...
                        <div class="mt-3 d-flex gap-2">
                            <div class="d-flex align-items-bottom gap-2">
                                ...
                                <p class="fs-14 text-muted">{{ datas.code || "-" }}</p>
                            </div>

                            
                            <div class="d-flex align-items-bottom gap-2">
                                <i class="mdi mdi-whatsapp fs-14 text-muted"></i>
                                <p class="fs-14 text-muted">{{ datas.category || "-" }}</p>
                            </div>

                            <div class="d-flex align-items-bottom gap-2">
                                <i class="mdi mdi-email fs-14 text-muted"></i>
                                <p class="fs-14 text-muted">{{ datas.quantity || "-" }}</p>
                            </div>
                        </div>
                    </BCardBody>
