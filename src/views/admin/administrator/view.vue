        ...
        <BRow v-if="datas">
            <BCol xl="12">
                <BCard>
                    <BCardBody>
                        <div class="">
                            <h3 class="mr-3">{{ datas.fullName }} | {{ datas.phoneNumber }}</h3>
                        </div>

                        <div class="mt-3 d-flex gap-2">
                            <div class="d-flex align-items-bottom gap-2">
                                <i class="mdi mdi-phone fs-14 text-muted"></i>
                                <p class="fs-14 text-muted">{{ datas.phoneNumber || "-" }}</p>
                            </div>

                            
                            <div class="d-flex align-items-bottom gap-2">
                                <i class="mdi mdi-whatsapp fs-14 text-muted"></i>
                                <p class="fs-14 text-muted">{{ datas.whatsappNumber || "-" }}</p>
                            </div>

                            <div class="d-flex align-items-bottom gap-2">
                                <i class="mdi mdi-email fs-14 text-muted"></i>
                                <p class="fs-14 text-muted">{{ datas.email || "-" }}</p>
                            </div>
                        </div>
                    </BCardBody>
